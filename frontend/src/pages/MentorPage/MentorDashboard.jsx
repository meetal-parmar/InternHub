  ...
  const fetchDashboard = async () => {
    try {
      ...
      const [statsRes, trendRes, notifRes, leavesRes] = await Promise.all([
        axios.get(`${BASE_URL}/api/mentor-dashboard/stats`, {
          headers,
        }),
        axios.get(
          `${BASE_URL}/api/mentor-dashboard/attendance-trends`,
          { headers }
        ),
        axios.get(`${BASE_URL}/api/mentor-dashboard/notifications`, {
          headers,
        }),
        axios.get(`${BASE_URL}/leaves/mentor`, { headers }), 
      ]);
