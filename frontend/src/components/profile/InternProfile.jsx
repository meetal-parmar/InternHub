...
//     // Type karte hi us specific field ki error clear ho jaye
...
//         isEdit ? "http://localhost:3000/profile" : "http://localhost:3000/profile/intern",
//         {
...
//         <h2 className="form-title">{isEdit ? "Update Profile" : "Create Profile"}</h2>
...
//           {/* ACADEMIC INFO */}
//           <div className="input-field">
//             <label>COLLEGE <span className="required-star">*</span></label>
...
//             <input type="text" name="yearOrSemester" value={form.yearOrSemester} onChange={handleChange} />
...
//             {errors.githubUrl && <span className="err-msg">{errors.githubUrl}</span>}
//           </div>

//           <div className="input-field">
//             <label>LINKEDIN URL</label>
//             <input type="text" name="linkedinUrl" value={form.linkedinUrl} onChange={handleChange} />
//             {errors.linkedinUrl && <span className="err-msg">{errors.linkedinUrl}</span>}
//           </div>

//           <div className="full-width">
//             <button type="submit" className="blue-btn">
//               {isEdit ? "Update Details" : "Save Profile"}
//             </button>
//           </div>
//         </form>
//       </div>
